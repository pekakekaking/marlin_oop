...
$routes = [
    ...
    "/category_index.php" => [__DIR__ . '/../controllers/CategoryController.php', 'index', __DIR__ . '/../views/category.index.view.php'],
    "/category_create.php" => [__DIR__ . '/../controllers/CategoryController.php', 'create', __DIR__ . '/../views/category.create.view.php'],
    "/category_store.php" => [__DIR__ . '/../controllers/CategoryController.php', 'store', null],
    "/category_edit.php" => [__DIR__ . '/../controllers/CategoryController.php', 'edit', __DIR__ . '/../views/category.edit.view.php'],
    "/category_update.php" => [__DIR__ . '/../controllers/CategoryController.php', 'update', null],
    "/category_destroy.php" => [__DIR__ . '/../controllers/CategoryController.php', 'destroy', null],
